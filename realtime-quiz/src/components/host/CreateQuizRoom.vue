    ...
    <div v-if="!showQuestions" class="host-home card">
      <div class="img-header">
        <a href="http://www.depa.eb.mil.br/" target="_blank">
          <img src="./assets/cm-3.png" class="card-img-top" alt="5º Desafio Global do Conhecimento" />
        </a>
      </div>
      <div v-if="!isRoomReady" class="card-body">
        <h2 class="card-title">
          
          {{ quizType === 'CustomQuiz' ? 'your own ' : 'Preparem-se! O Quiz está quase começando. ' }}
        ...
        <p class="card-text">
          Esse nome é para os jogadores do seu Quiz possam identificá-lo.
        </p>
        <input
          class="form-control input-box"
          placeholder="Entre com o nome do host "
